...
<body>
        ...
        <div class="inspection-modal-content">
            ...
            <div class="inspection-border">
                ...
                <div id="rejected-attachments-section" class="form-group remarks-content" style="display: none;">
                    <label style="font-weight: bold;">Rejected File Attachments:</label>
    ...
    <!-- Back End JS -->
    <script src="inspection-filter-table-rejected.js" type="text/javascript"></script>
    <script src="inspection-qa-task-rejected.js?v=4" type="text/javascript"></script>
