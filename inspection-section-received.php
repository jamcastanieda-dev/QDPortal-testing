...
<body>
    ...
    <div class="container">
        ...
        <div>
            <button id="requestBtn" class="pecalibration-btn">
                <span class="btn-badge" id="requestCount">0</span>
                Request
            </button>
            <button id="peCalibrationBtn" class="pecalibration-btn">
                <span class="btn-badge" id="peCalibrationCount">0</span>
                PE Calibration
            </button>
        </div>
        <style>
            .pecalibration-btn.active {
            ...
            .btn-badge {
                position: absolute;
                top: -10px;
                /* a bit tighter to the top */
                right: -15px;
                /* switch from left to right and align nicely */
                min-width: 22px;
                height: 22px;
                padding: 0 7px;
                border-radius: 12px;
                ...
                box-shadow: 0 2px 6px rgba(30, 41, 59, 0.09);
                z-index: 2;
            }
        </style>
        ...
        <div id="action-container" class="action-container hidden">
            ...
            <button class="action-btn view-btn" id="reject-button">Reject</button>
            <button class="action-btn view-btn" id="pe-calibration-button" style="display: none;">PE Calibration</button>
        </div>
    ...
    <script src="inspection-modal-reject.js" type="text/javascript"></script>
    ...
    <script src="inspection-filter-table-received.js?v=3" type="text/javascript"></script>
    <script src="inspection-qa-task-received.js?v=8" type="text/javascript"></script>
