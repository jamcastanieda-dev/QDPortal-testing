...
<body>
    ...
    <div id="completion-modal" class="remarks-modal">
        <div class="remarks-modal-content">
            <button class="remarks-close-btn" id="completion-close">&times;</button>
            <h3>Remarks for Completion</h3>
            <textarea id="completion-remarks" name="completion-remarks" rows="4" style="width:100%; resize: none;"></textarea>
            <div style="text-align: right; margin-top: 10px;">
                <button id="completion-submit" class="submit-btn">Approve</button>
            </div>
        </div>
    </div>
    ...
    <!-- Reject Modal -->
    <?php include 'inspection-modal-reject-for-approval.php' ?>
    ...
    <!-- Back End JS -->
    <script src="inspection-filter-table-for-completion.js" type="text/javascript"></script>
    <script src="inspection-populate-elements.js?v=3.1" type="text/javascript"></script>
    <script src="inspection-qa-task-for-completion.js?v=7.1" type="text/javascript"></script>
