...
<body>
    ...
    <script src="inspection-filter-table-rescheduled.js" type="text/javascript"></script>
    <script src="inspection-populate-elements.js?v=3.1" type="text/javascript"></script>
    <script src="inspection-qa-task-rescheduled.js?v=4" type="text/javascript"></script>
