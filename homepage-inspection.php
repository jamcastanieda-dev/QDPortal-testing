...
// Check privilege
if (empty($user['privilege']) || $user['privilege'] !== 'Initiator-Inspection') {
    header('Location: login.php');
    exit;
}
...
<body>
    ...
    <div class="container">
        ...
        <button class="create-button" id="openInspectionModal">Create</button><br><br><br>
        <!-- Scrollable Table -->
    ...
    <div id="viewInspectionModal" class="inspection-modal">
        <div class="inspection-modal-content">
            ...
            <div class="inspection-border">
                ...
                <button class="reschedule-button" id="reschedule-request"><i class="fa-regular fa-clock icon-clock"></i>Reschedule</button><br><br>

                <!-- Only show this if status is COMPLETED -->
                <div id="inspection-completed-attachments" class="modal-container">
                    <label class="medium-label" for="view_completed-attachments">Attachments For Completion:</label>
    ...
    <script src="inspection-rescheduled-data-insert.js" type="text/javascript"></script>
