    ...
    <nav id="sidebar">
        ...
        <ul class="sidebar-menu-list">
            <li class="not-selected">
                <a href="ncr-creation-initiator.php">NCR<span class="notification-badge">8</span></a>
            </li>
            <li class="not-selected">
    ...
    <div id="taskModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-buttons">
                ...
                <a id="returnedLink" class="modal-btn" href="#">Returned</a>
            </div>
        </div>
    </div>
    <script src="homepage-head.js" type="text/javascript"></script>
