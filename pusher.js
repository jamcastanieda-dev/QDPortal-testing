        ...
        return (
          (e = function (t) {
            return (
              ...
              encodeURIComponent(((e = t.toString()), R(L(e))))
            );
            var e;
          }),
          (n = {}),
      ...
      var pt = (function () {
        ...
        ft = (function (t) {
          function e(e, n, r, o, i) {
            ...
            return (
              (s.initialize = Se.transportConnectionInitializer),
              (s.hooks = e),
              (s.name = n),
              (s.priority = r),
              (s.key = o),
          ...
          return (
            (t.prototype.send = function (t, e) {
              this.timeline.isEmpty() ||
                this.timeline.send(Se.TimelineTransport.getAgent(this, t), e);
            }),
            t
          );
        })(),
          ...
          (t.prototype.connect = function (t, e) {
            ...
            if (r && r.timestamp + this.ttl >= U.now()) {
              ...
              i &&
                ...
                o.push(
                  new $t([i], { timeout: 2 * r.latency + 1e3, failFast: !0 })
                ));
            }
            var s = U.now(),
      ...
      var ce,
        ae = function (t, e, n) {
          ...
          var i,
            ...
            C = new $t(
              [new oe(se(S), new Kt([S, new re(k, { delay: 4e3 })]), k)],
              u
            ),
            T = new oe(se(C), C, w);
          return (
            (i = e.useTLS
              ? new Kt([m, new re(T, { delay: 2e3 })])
              : new Kt([
                  m,
                  new re(_, { delay: 2e3 }),
                  new re(T, { delay: 5e3 }),
        ...
        pe = (function (t) {
          ...
          return (
            ...
            (e.prototype.close = function () {
              this.unloader &&
                (Se.removeUnloadListener(this.unloader),
                (this.unloader = null)),
                this.xhr &&
        ...
        ve = (function () {
          ...
          return (
            ...
            (t.prototype.openStream = function () {
              var t = this;
              (this.stream = Se.createSocketRequest(
                "POST",
                de(this.hooks.getReceiveURL(this.location, this.session))
              )),
          ...
          return (
            (t.prototype.log = function (t, e) {
              t <= this.options.level &&
                (this.events.push(z({}, e, { timestamp: U.now() })),
                this.options.limit &&
          ...
          return (
            !(
              ...
              ? ((o = Object.assign(
                ...
                (s = new Te(e, r, i ? i.getAssistant(c) : c, o)))
              : (s = Ae),
            s
          );
        },
        ...
        var n = (function (t, e) {
          ...
          return (
            "channelAuthorization" in t
              ? (n = Re({}, s.channelAuthorization, t.channelAuthorization))
              : ((n = {
        ...
        qe = (function (t) {
          ...
          return (
            ...
            (e.prototype._signin = function () {
              ...
              if (
                ...
                this.pusher.config.userAuthenticator(
                  ...
                  function (e, n) {
                    e
                      ? Z.warn("Error during signin: " + e)
                      : t.pusher.send_event("pusher:signin", {
                          auth: n.auth,
            ...
            (e.prototype._onSigninSuccess = function (t) {
              ...
              "string" == typeof this.user_data.id && "" !== this.user_data.id
        ...
        Be = (function () {
          function t(e, n) {
            ...
            if (
              ...
              Z.warn(
                "You should always specify a cluster when connecting. " + a
              );
            }
            "disableStats" in n &&
              Z.warn(
          ...
          return (
            ...
            (t.getClientFeatures = function () {
              return X(
                V({ ws: Se.Transports.ws }, function (t) {
                  return t.isSupported({});
                })
              );
            }),
