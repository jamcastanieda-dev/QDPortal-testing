...
<body>
    ...
    <div class="rcpa-content-container">
        ...
        <div class="inner-container">
            ...
            <div class="border-container">
                ...
                <div class="row">
                    <div class="column">
                        ...
                        <div class="request-valid-indentation">
                        ...
                        <div class="request-valid-indentation potential-nonconformance-section">
                            ...
                            <div class="long-grid">
                                <label for="assignee-potential" class="rcpa-label">Assignee:</label>
                                <input type="text" id="assignee-potential" name="assignee-potential">
                                <label for="head-date" class="rcpa-label">Date:</label>
                                <input type="date" id="assignee-potential-date" name="assignee-potential-date">

                                <label for="assignee-head" class="rcpa-label">Assignee/Supervisor/Head:</label>
                                <input type="text" id="assignee-head" name="assignee-head">
                                <label for="assignee-head-date" class="rcpa-label">Date:</label>
                                <input type="date" id="assignee-head-date" name="assignee-head-date">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- New Border Container 1 -->
            <div class="border-container">
                <div>
                    <input type="radio" id="not-valid" name="not-valid" class="custom-radio top-position">
                    <label for="non-validity" class="rcpa-label">Finding not valid, Reason for non-validity</label>
                </div>
                <div class="row">
                    <div class="column aligned-label">
                        <textarea id="non-validity" class="custom-textarea" name="non-validity" placeholder="Enter the reason for non-validity..."></textarea>
                    </div>
                </div>
                <div class="long-grid">
                    <label for="head" class="rcpa-label">Assignee/Supervisor/Head:</label>
                    <input type="text" id="head" name="head">
                    <label for="head-date" class="rcpa-label">Date:</label>
                    <input type="date" id="head-date" name="head-date">

                    <label for="qms" class="rcpa-label">QMS Team:</label>
                    <input type="text" id="qms" name="qms">
                    <label for="qms-date" class="rcpa-label">Date:</label>
                    <input type="date" id="qms-date" name="qms-date">

                    <label for="originator-for-reason" class="rcpa-label">Originator:</label>
                    <input type="text" id="originator-for-reason" name="originator-for-reason">
                    <label for="originator-for-reason-date" class="rcpa-label">Date:</label>
                    <input type="date" id="originator-for-reason-date" name="originator-for-reason-date">
                </div>
            </div>

            <!-- New Border Container 2 -->
            <div class="border-container">
                <label for="newField4">(Verification of Implementation on Correction, Corrective Action, Preventitve Action)</label>
                <div class="row">
                    <div class="column">
                        <label for="newField4" class="rcpa-label" style="margin-left: 200px;">Action Done</label>
                    </div>
                    <div class="column">
                        <div class="items-aligned" style="margin-left: 200px;">
                            <input type="radio" id="yes" name="action" class="custom-radio">
                            <label for="newField5">Yes</label>
                        </div>
                    </div>
                    <div class="column">
                        <div style="margin-left: 0px;">
                            <input type="radio" id="no" name="action" class="custom-radio">
                            <label for="newField6">No</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="column">
                        <label for="newTextarea2">Remarks</label>
                        <textarea id="newTextarea2" class="custom-textarea" name="newTextarea2" placeholder="Provide additional details here..."></textarea>
                    </div>
                </div>

                <div class="long-grid">
                    <label for="originator-verification" class="rcpa-label">Originator/Supervisor:</label>
                    <input type="text" id="originator-verification" name="originator-verification">
                    <label for="originator-verification-date" class="rcpa-label">Date:</label>
                    <input type="date" id="originator-verification-date" name="originator-verification-date">

                    <label for="assignee-verification" class="rcpa-label">Assignee/Supervisor/Head:</label>
                    <input type="text" id="assignee-verification" name="assignee-verification">
                    <label for="assignee-verification-date" class="rcpa-label">Date:</label>
                    <input type="date" id="assignee-verification-date" name="assignee-verification-date">

                    <label for="qms-verification" class="rcpa-label">QMS Team:</label>
                    <input type="text" id="qms-verification" name="qms-verification">
                    <label for="qms-verification-date" class="rcpa-label">Date:</label>
                    <input type="date" id="qms-verification-date" name="qms-verification-date">
                </div>
            </div>

            <div class="border-container">
                <label for="newField4">(Follow-up for Effectiveness of Action Taken)</label>
                <div class="row">
                    <div class="column">
                        <label for="newField4" class="rcpa-label" style="margin-left: 200px;">Status:</label>
                    </div>
                    <div class="column">
                        <div class="items-aligned" style="margin-left: 200px;">
                            <input type="radio" id="closed" name="status" class="custom-radio">
                            <label for="newField5">Closed</label>
                        </div>
                    </div>
                    <div class="column">
                        <div style="margin-left: 0px;">
                            <input type="radio" id="open" name="status" class="custom-radio">
                            <label for="newField6">Open</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="short-grid">
                    <label for="qms-team" class="rcpa-label">QMS Team:</label>
                    <input type="text" id="qms-team" name="qms-team">
                    <label for="qms-team-date" class="rcpa-label">Date:</label>
                    <input type="date" id="qms-team-date" name="qms-team-date">

                    <label for="qm-r-team" class="rcpa-label">QM & R Team:</label>
                    <input type="text" id="qm-r-team" name="qm-r-team">
                    <label for="qm-r-team-date" class="rcpa-label">Date:</label>
                    <input type="date" id="qm-r-team-date" name="qm-r-team-date">
                </div>
            </div><br><br>
...
<script src="rcpa-css.js" type="text/javascript"></script>
