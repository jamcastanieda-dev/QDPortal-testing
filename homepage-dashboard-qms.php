...
// Check privilege
if (empty($user['privilege']) || $user['privilege'] !== 'QMS') {
    header('Location: login.php');
    exit;
}
    ...
    <nav id="sidebar">
        <ul class="sidebar-menu-list">
            ...
            <li class="not-selected">
                ...
                <ul class="submenu">
                    <li class="not-selected"><a href="inspection-dashboard-qms.php">Dashboard</a></li>
            ...
            <li class="not-selected">
                ...
                <ul class="submenu">
                    ...
                    <li class="not-selected"><a href="rcpa/php/rcpa-request.php">Request</a></li>
                </ul>
            </li>
            <!--<li class="not-selected">
