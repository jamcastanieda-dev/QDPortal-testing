...
// Check privilege
if (empty($user['privilege']) || $user['privilege'] !== 'PPIC-Inspection') {
    header('Location: login.php');
    exit;
}
...
<body>
    ...
    <h2>Inspection Request Dashboard</h2>
    <!-- Content Container -->
    <div class="container">
        <!-- Scrollable Table -->
    ...
    <div id="viewInspectionModal" class="inspection-modal">
        <div class="inspection-modal-content">
            ...
            <div class="inspection-border">
                    ...
                    <div id="view-columnTwo" class="column">
                        <div class="second-column">
                            ...
                            <div class="outgoing-inspection-group option-group">
                                <input type="radio" id="view-outgoing-inspection" name="view-inspection-type" class="custom-radio" value="outgoing" disabled/>
                ...
                <!-- Only show this if status is REJECTED -->
                <div id="inspection-rejected-attachments" class="modal-container">
                    <label class="medium-label">Attachments For Rejection:</label>
                    <div class="completed-group">
                        <label class="document-no-label">Document No:</label>
    ...
    <script src="inspection-data-retrieve-ppic.js" type="text/javascript"></script>
    ...
    <script src="inspection-reject-data-retrieve.js" type="text/javascript"></script>
