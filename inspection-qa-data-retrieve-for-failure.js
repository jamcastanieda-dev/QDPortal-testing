...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchInspectionData() {
        ...
        document.getElementById('approve-failure-button').addEventListener('click', function () {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('inspection-update-for-failure.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded'
                        },
                        ...
                        .then(result => {
                            if (result.success) {
                                Swal.fire({
                                    ...
                                    DateTime();
                                    InsertRequestHistory(inspectionNo, formattedTime, 'Failure of inspection request has been approved.');
                        ...
                        .then(result => {
                            if (result.success) {
                                Swal.fire({
                                    ...
                                    DateTime();
                                    InsertRequestHistory(inspectionNo, formattedTime, 'Failure for inspection request has been rejected. Reason: ' + rejectRemarks.value);
                                    hideRejectModal();
                                    if (socket && socket.readyState === WebSocket.OPEN) {
                                        socket.send(JSON.stringify({
                                            action: 'change'
