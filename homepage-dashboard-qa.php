...
if (isset($user['privilege']) && $user['privilege'] === 'QA-Head-Inspection') {
    header('Location: inspection-homepage-dashboard-qa-head.php');
    exit;
} elseif (!isset($user['privilege']) || $user['privilege'] !== 'QA-Respondent') {
    header('Location: login.php');
    exit;
}
...
<body>
    ...
    <nav id="sidebar">
        <ul class="sidebar-menu-list">
            ...
            <!--<li class="not-selected">
                ...
                <ul class="submenu">
                    <li class="not-selected"><a href ="ncr/ncr-task-qa.php">Tasks</a></li>
                    <li class="not-selected"><a href="ncr/ncr-dashboard-qa.php">Dashboard</a></li>
                </ul>
            </li>
            <li class="not-selected">
    ...
    <h2>Dashboard <span class="arrow">></span><span class="home-label"> Home</span></h2>
    <!-- Content Container -->
    <div class="container">
