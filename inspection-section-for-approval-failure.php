...
<body>
    ...
    <div class="container">
        ...
        <div id="action-container-failure" class="action-container hidden">
            <button class="action-btn view-btn" id="view-failure-button">View</button>
            <button class="action-btn view-btn" id="approve-failure-button">Approve</button>
            <button class="action-btn view-btn" id="reject-failure-button">Reject</button>
        </div>
    ...
    <!-- Back End JS -->
    <script src="inspection-filter-table-for-failure.js" type="text/javascript"></script>
    <script src="inspection-populate-elements.js?v=3.1" type="text/javascript"></script>
    <script src="inspection-qa-task-for-failure.js?v=4" type="text/javascript"></script>
