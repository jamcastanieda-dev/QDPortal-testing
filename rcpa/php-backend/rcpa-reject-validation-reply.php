<?php
// php-backend/rcpa-reject-validation-reply.php
...
$status = 'VALID APPROVAL'; // ← per your request
...
try {
    ...
    // 2) Handle attachments (any file type)
    $attachments = [];
    if (isset($_FILES['attachments']) && is_array($_FILES['attachments']['name'])) {
        ...
        // Web base starts at /qdportal-testing/rcpa/
    ...
    // 4) History entry (validation-reply specific)
    $activity = "The validation reply by Assignee was disapproved by QA/QMS";
