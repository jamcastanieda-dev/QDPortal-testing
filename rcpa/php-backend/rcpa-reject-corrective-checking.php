...
$status = 'FOR CLOSING APPROVAL'; // return to assignee
...
try {
    ...
    $disapproveType = "Disapproved by QA/QMS Team in Corrective Checking";
    ...
    $activity = "The corrective action evidence by Assignee Supervisor/Manager was disapproved by QA/QMS Team";
