...
$status = 'FOR CLOSING'; // return to assignee
...
try {
    ...
    $disapproveType = "Disapproved by Assignee Supervisor/Manager in Assignee Corrective Approval";
    ...
    $activity = "The corrective action evidence by Assignee was disapproved by Assignee Supervisor/Manager";
