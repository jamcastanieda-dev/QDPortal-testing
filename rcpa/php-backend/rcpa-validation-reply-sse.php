<?php
// php-backend/rcpa-validation-reply-sse.php
...
/* -------- Resolve department + QA/QMS (mirror list) -------- */
$user_dept = null;
$is_qaqms  = false;
...
/* -------- Inputs -------- */
$type = trim((string)($_GET['type'] ?? '')); // optional rcpa_type

/* -------- WHERE (mirror rcpa-list-validation-reply.php) -------- */
