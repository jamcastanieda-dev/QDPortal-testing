<?php
// php-backend/rcpa-qms-checking-sse.php
...
/* -------- Resolve department & QA/QMS flag -------- */
$user_dept = null;
$is_qaqms  = false;
...
/* -------- WHERE (mirror rcpa-list-qms-checking.php) -------- */
$allowed_statuses = ['QMS CHECKING'];
...
/* -------- Snapshot query: NO id>since; watch (max_id, count) -------- */
