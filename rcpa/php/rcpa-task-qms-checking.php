...
<body>
    ...
    <h2><span>QMS Tasks (QMS CHECKING)</span></h2>
        ...
        <section class="rcpa-card">
            <header class="rcpa-table-toolbar">
                ...
                <div class="rcpa-tabs" role="group" aria-label="RCPA views">
                    ...
                    <button type="button" class="rcpa-tab" data-href="rcpa-task-validation-reply.php">
                        REPLIED - VALID
                    </button>
                    <button type="button" class="rcpa-tab" data-href="rcpa-task-invalidation-reply.php">
                        REPLIED - INVALID
                    </button>
                    <button type="button" class="rcpa-tab" data-href="rcpa-task-qms-corrective.php">
                        EVIDENCE CHECKING
                    </button>
                </div>
    ...
    <div class="modal-overlay" id="rcpa-view-modal" hidden>
        <div class="modal-content">
            ...
            <form class="rcpa-form" action="#" method="post" novalidate>
                ...
                <!-- actions row kept for spacing; no submit -->
                <div class="actions">
                    <button type="button" id="rcpa-view-edit-btn">Edit</button>
                </div>
            </form>
        </div>
    </div>

    <!-- ✅ NEW: Read-only disapproval-remarks viewer -->
    <div id="reject-remarks-modal" class="modal-overlay" aria-hidden="true">
        <div class="modal-content">
            ...
            <div class="stack" style="margin-top:10px;">
                ...
                <div class="attach-list" id="reject-remarks-attach-list" aria-live="polite"></div>
            </div>
        </div>
    </div>

    <!-- ✅ NEW: QMS Reject modal (textarea + paperclip multi-file) -->
            ...
            <form id="rcpa-reject-form" novalidate enctype="multipart/form-data">
                <label class="field" style="display:block;margin-top:8px;">
                    <div class="reject-attach-wrap">
                        ...
                        <!-- Paperclip-only button -->
                        <button type="button" class="attach-icon reject-attach-icon" id="rcpa-reject-clip" title="Attach files">
