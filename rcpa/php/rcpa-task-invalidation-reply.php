...
<body>
    ...
    <h2><span>QMS Tasks (REPLIED - INVALID)</span></h2>
        ...
        <section class="rcpa-card">
            <header class="rcpa-table-toolbar">
                ...
                <div class="rcpa-tabs" role="group" aria-label="RCPA views">
                    <button type="button" class="rcpa-tab" data-href="rcpa-task-qms-checking.php">
                        QMS CHECKING
                    </button>
    ...
    <!-- Reject back to Assignee (modal for remarks + attachments) -->
    ...
    <script src="../js/rcpa-task-invalidation-reply.js?v=1.1"></script>
