...
<body>
    ...
    <h2><span>RCPA CLOSED</span></h2>

    <!-- rcpa-task-assignee-approval-corrective.php -->
    ...
    <div class="modal-overlay" id="rcpa-view-modal" hidden>
        <div class="modal-content">
            ...
            <form class="rcpa-form" action="#" method="post" novalidate>
                ...
                <!-- Actions -->
                <div class="actions" style="margin-top:12px; display:flex; justify-content:end; gap:8px;">
                    <button type="button" id="rcpa-followup-open">Add follow up for effectiveness</button>
                </div>
            </form>
        </div>
    </div>

    <!-- Follow-up for Effectiveness modal -->
    <div class="modal-overlay" id="rcpa-followup-modal" hidden>
        <div class="modal-content" id="rcpa-followup-content">
            <button type="button" class="close-btn" id="rcpa-followup-close" aria-label="Close">&times;</button>
            <h3>Follow up for Effectiveness of Action Taken</h3>


            <label class="field" style="margin-top:10px;max-width:320px;">
                <span>Target Date:</span>
                <input class="u-line u-dt" type="date" id="rcpa-followup-date" required>
            </label>

            <form id="rcpa-followup-form" novalidate enctype="multipart/form-data">
                <label class="field" style="display:block;margin-top:8px;">
                    <span>Remarks</span>
                    <div class="reject-attach-wrap">
                        <textarea id="rcpa-followup-remarks" class="u-area" rows="6" placeholder="Describe the follow-up..." required></textarea>

                        <!-- paperclip button -->
                        <button type="button" class="attach-icon reject-attach-icon"
                            id="rcpa-followup-clip" title="Attach files">
                            <i class="fa-solid fa-paperclip" aria-hidden="true"></i>
                        </button>

                        <!-- count badge -->
                        <span class="attach-badge reject-attach-badge" id="rcpa-followup-attach-count" hidden>0</span>

                        <!-- hidden file input (allow ALL file types) -->
                        <input id="rcpa-followup-files" name="attachments[]" type="file" multiple class="visually-hidden">
                    </div>
                </label>

                <div class="reject-files-list" id="rcpa-followup-files-list" style="margin-top:6px;"></div>

                <!-- Existing attachments preview (read-only) -->
                <div class="attach-wrap" id="rcpa-followup-existing" hidden>
                    <div class="desc-title" style="margin-bottom:.25rem;">Current attachments</div>
                    <div class="attach-list" id="rcpa-followup-existing-list" aria-live="polite"></div>
                </div>

                <div class="actions" style="margin-top:12px; display:flex; gap:8px;">
                    <button type="button" id="rcpa-followup-cancel">Cancel</button>
                    <button type="submit" id="rcpa-followup-submit">Submit</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="rcpa-reject-modal" hidden>
        <div class="modal-content" id="rcpa-reject-content">
            ...
            <h3>Return to Assignee Supervisor/Manager — Reason</h3>
    ...
    <script src="../js/rcpa-task-closed.js?v=1.1"></script>
