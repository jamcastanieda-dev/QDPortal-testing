...
<head>
    ...
    <title>RCPA VALID APPROVAL</title>
</head>
...
<body>
    ...
    <h2><span>RCPA VALID APPROVAL</span></h2>
    ...
    <div class="rcpa-container">
        ...
        <section class="rcpa-card">
            <header class="rcpa-table-toolbar">
                ...
                <!-- rcpa-task-assignee-corrective.php -->
                <!-- New top buttons -->
                <div class="rcpa-tabs" role="group" aria-label="RCPA views">
                    <a class="rcpa-tab" aria-current="page" href="rcpa-task-assignee-pending.php">
                        ASSIGNEE PENDING
                    </a>
    ...
    <div class="modal-overlay" id="rcpa-accept-modal" hidden>
        <div class="modal-content" id="rcpa-accept-content">
            <button type="button" class="close-btn" id="rcpa-accept-close" aria-label="Close">&times;</button>
            <h3>Corrective Action Evidence</h3>

            <form id="rcpa-accept-form" novalidate enctype="multipart/form-data">
                <label class="field" style="display:block;margin-top:8px;">
                    <!-- reuse reject classes for identical positioning -->
                    <div class="reject-attach-wrap">
                        <textarea id="rcpa-accept-remarks" class="u-area" rows="6"
                            placeholder="Enter corrective action..." required></textarea>

                        <!-- paperclip button (icon only) -->
                        <button type="button" class="attach-icon reject-attach-icon"
                            id="rcpa-accept-clip" title="Attach files">
                            <i class="fa-solid fa-paperclip" aria-hidden="true"></i>
                        </button>

                        <!-- count badge -->
                        <span class="attach-badge reject-attach-badge" id="rcpa-accept-attach-count" hidden>0</span>

                        <!-- hidden file input (allow ALL file types) -->
                        <input id="rcpa-accept-files" name="attachments[]" type="file" multiple class="visually-hidden">
                    </div>
                </label>

                <!-- list of selected files -->
                <div class="accept-files-list" id="rcpa-accept-files-list"></div>

                <div class="actions" style="margin-top:12px; display:flex; gap:8px;">
                    <button type="button" id="rcpa-accept-cancel">Cancel</button>
                    <button type="submit" id="rcpa-accept-submit">Submit</button>
                </div>
            </form>
        </div>
    </div>
