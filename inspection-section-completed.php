...
<body>
    ...
    <!-- Content Container -->
    <div class="container">
        <a href="inspection-tasks-qa.php" class="back-button"><i
                class="fa-solid fa-right-from-bracket fa-flip-horizontal"></i> Back</i></a>
        <!-- Filters -->
    ...
    <!-- Back End JS -->
    <script src="inspection-filter-table-completed.js" type="text/javascript"></script>
    <script src="inspection-qa-task-completed.js?v=7" type="text/javascript"></script>
